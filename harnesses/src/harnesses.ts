...
// STORY-020 (event visualization) and STORY-021 (upgrade preview) follow.
...
export const harnesses: SceneHarness[] = [restaurantLayoutHarness, customerFlowHarness, kitchenBottleneckHarness];
